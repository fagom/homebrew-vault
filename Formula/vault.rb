class Vault < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://github.com/fagom/vault-cli/releases/download/v1.0.13/vault-darwin-amd64.tar.gz"
      sha256 "76241e622bc65c4012bfe5831dfac128da437e4e10aa6c128d3f8c1aff03271b"
    elsif Hardware::CPU.arm?
      url "https://github.com/fagom/vault-cli/releases/download/v1.0.13/vault-darwin-arm64.tar.gz"
